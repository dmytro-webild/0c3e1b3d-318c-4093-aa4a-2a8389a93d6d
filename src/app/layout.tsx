...
export const metadata: Metadata = {
  ...
  twitter: {
    card: "summary_large_image",    title: "Apna Mens Wear | Premium Menswear",    description: "Shop menswear collections with fast delivery. Call 09630105490",    images: ["http://img.b2bpic.net/free-photo/groom-preparing-his-wedding_1303-28300.jpg"],
  },
  robots: {
    index: true,
    follow: true,
